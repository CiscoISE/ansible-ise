...
htmlhelp_basename = 'ISEAnsibleActionsdoc'
...
latex_documents = [
    (master_doc, 'ISEAnsibleActions.tex', 'ISEAnsibleActions Documentation',
     'The ISE Project', 'manual'),
]
...
man_pages = [
    (master_doc, 'ISEAnsibleActions', 'ISEAnsibleActions Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ISEAnsibleActions', 'ISEAnsibleActions Documentation',
     author, 'ISEAnsibleActions', 'One line description of project.',
     'Miscellaneous'),
]

...
.. _ansible_collections.cisco.ise.ise_root_ca_regenerate_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.ise_root_ca_regenerate`.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-removeExistingISEIntermediateCSR"></div>
                    <b>removeExistingISEIntermediateCSR</b>
                    <a class="ansibleOptionLink" href="#parameter-removeExistingISEIntermediateCSR" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Setting this attribute to true will remove existing ISE Intermediate CSR.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   `Ise Root Ca Regenerate reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Ise Root Ca Regenerate object model.

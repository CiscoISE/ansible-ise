...
.. _ansible_collections.cisco.ise.sponsor_group_member_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.sponsor_group_member_info`.
...
.. seealso::
   ...
   `Sponsor Group Member reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Sponsor Group Member object model.

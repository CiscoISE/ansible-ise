...
.. _ansible_collections.cisco.ise.mnt_session_by_ip_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.mnt_session_by_ip_info`.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-endpoint_ipv4"></div>
                    <b>endpoint_ipv4</b>
                    <a class="ansibleOptionLink" href="#parameter-endpoint_ipv4" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Endpoint_ipv4 path parameter.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   `Mnt Session By Ip reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Mnt Session By Ip object model.

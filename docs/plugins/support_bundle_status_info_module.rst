...
.. _ansible_collections.cisco.ise.support_bundle_status_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.support_bundle_status_info`.
...
.. seealso::
   ...
   `Support Bundle Status reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Support Bundle Status object model.

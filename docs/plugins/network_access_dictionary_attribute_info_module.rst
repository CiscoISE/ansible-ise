...
.. _ansible_collections.cisco.ise.network_access_dictionary_attribute_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.network_access_dictionary_attribute_info`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>DictionaryName path parameter. The name of the dictionary the dictionary attribute belongs to.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Name path parameter. The dictionary attribute name.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>

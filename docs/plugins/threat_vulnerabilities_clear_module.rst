...
.. _ansible_collections.cisco.ise.threat_vulnerabilities_clear_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.threat_vulnerabilities_clear`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Threat Vulnerabilities Clear&#x27;s macAddresses.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   `Threat Vulnerabilities Clear reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Threat Vulnerabilities Clear object model.

...
.. _ansible_collections.cisco.ise.mnt_version_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.mnt_version_info`.
...
.. seealso::
   ...
   `Mnt Version reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Mnt Version object model.

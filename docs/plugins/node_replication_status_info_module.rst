...
.. _ansible_collections.cisco.ise.node_replication_status_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.node_replication_status_info`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Node path parameter. ID of the existing node.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   `Node Replication Status reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Node Replication Status object model.

...
.. _ansible_collections.cisco.ise.csr_generate_intermediate_ca_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.csr_generate_intermediate_ca`.
...
.. seealso::
   ...
   `Csr Generate Intermediate Ca reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Csr Generate Intermediate Ca object model.

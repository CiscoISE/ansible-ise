...
.. _ansible_collections.cisco.ise.device_administration_authorization_reset_hitcount_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.device_administration_authorization_reset_hitcount`.
...
.. seealso::
   ...
   `Device Administration Authorization Reset Hitcount reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Device Administration Authorization Reset Hitcount object model.

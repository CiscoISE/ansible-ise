...
.. _ansible_collections.cisco.ise.byod_portal_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.byod_portal_info`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Id path parameter. Portal id.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
...
.. seealso::
   ...
   `Byod Portal reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_

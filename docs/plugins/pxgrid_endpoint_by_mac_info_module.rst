...
.. _ansible_collections.cisco.ise.pxgrid_endpoint_by_mac_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.pxgrid_endpoint_by_mac_info`.
...
.. seealso::
   ...
   `Pxgrid Endpoint By Mac Info reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Pxgrid Endpoint By Mac Info object model.

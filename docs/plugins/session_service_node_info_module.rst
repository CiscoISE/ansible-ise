...
.. _ansible_collections.cisco.ise.session_service_node_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.session_service_node_info`.
...
.. seealso::
   ...
   `Session Service Node reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Session Service Node object model.

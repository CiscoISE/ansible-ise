...
.. _ansible_collections.cisco.ise.device_administration_policy_set_reset_hitcount_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.device_administration_policy_set_reset_hitcount`.
...
.. seealso::
   ...
   `Device Administration Policy Set Reset Hitcount reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Device Administration Policy Set Reset Hitcount object model.

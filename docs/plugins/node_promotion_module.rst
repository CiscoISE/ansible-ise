...
.. _ansible_collections.cisco.ise.node_promotion_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.node_promotion`.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-promotionType"></div>
                    <b>promotionType</b>
                    <a class="ansibleOptionLink" href="#parameter-promotionType" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Node Promotion&#x27;s promotionType.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   `Node Promotion reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Node Promotion object model.

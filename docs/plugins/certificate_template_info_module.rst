...
.. _ansible_collections.cisco.ise.certificate_template_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.certificate_template_info`.
...
.. seealso::
   ...
   `Certificate Template reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Certificate Template object model.

...
.. _ansible_collections.cisco.ise.guest_user_deny_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.guest_user_deny`.
...
.. seealso::
   ...
   `Guest User Deny reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Guest User Deny object model.

...
.. _ansible_collections.cisco.ise.device_administration_time_date_conditions_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.device_administration_time_date_conditions_info`.

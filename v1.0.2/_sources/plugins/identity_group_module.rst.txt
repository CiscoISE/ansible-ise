...
.. _ansible_collections.cisco.ise.identity_group_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.identity_group`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Identity Group&#x27;s description.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Identity Group&#x27;s parent.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   `Identity Group reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Identity Group object model.

...
.. _ansible_collections.cisco.ise.system_certificate_export_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.system_certificate_export_info`.
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-export"></div>
                    <b>export</b>
                    <a class="ansibleOptionLink" href="#parameter-export" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>System Certificate Export Info&#x27;s export.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>System Certificate Export Info&#x27;s id.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>System Certificate Export Info&#x27;s password.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
...
.. seealso::
   ...
   `System Certificate Export Info reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the System Certificate Export Info object model.

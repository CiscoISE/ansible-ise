...
.. _ansible_collections.cisco.ise.profiler_profile_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.profiler_profile_info`.
...
.. seealso::
   ...
   `Profiler Profile reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Profiler Profile object model.

...
.. _ansible_collections.cisco.ise.guest_user_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.guest_user_info`.
...
.. seealso::
   ...
   `Guest User reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_

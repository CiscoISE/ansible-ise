...
.. _ansible_collections.cisco.ise.network_access_dictionary_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.network_access_dictionary`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The description of the Dictionary.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-dictionaryAttrType"></div>
                    <b>dictionaryAttrType</b>
                    <a class="ansibleOptionLink" href="#parameter-dictionaryAttrType" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>The dictionary attribute type.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Identifier for the dictionary.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">dictionary</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Network Access Dictionary&#x27;s link.</div>
                                                        </td>
            </tr>
                                        <tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Network Access Dictionary&#x27;s href.</div>
                                                        </td>
            </tr>
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Network Access Dictionary&#x27;s rel.</div>
                                                        </td>
            </tr>
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Network Access Dictionary&#x27;s type.</div>
                                                        </td>
            </tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The dictionary version.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   `Network Access Dictionary reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Network Access Dictionary object model.

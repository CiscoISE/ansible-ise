...
.. _ansible_collections.cisco.ise.guest_ssid_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.guest_ssid`.
...
.. seealso::
   ...
   `Guest Ssid reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Guest Ssid object model.

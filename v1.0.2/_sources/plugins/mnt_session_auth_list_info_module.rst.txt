...
.. _ansible_collections.cisco.ise.mnt_session_auth_list_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.mnt_session_auth_list_info`.
...
.. seealso::
   ...
   `Mnt Session Auth List reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Mnt Session Auth List object model.

...
.. _ansible_collections.cisco.ise.network_access_dictionary_attributes_authentication_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.network_access_dictionary_attributes_authentication_info`.
...
.. seealso::
   ...
   `Network Access Dictionary Attributes Authentication reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Network Access Dictionary Attributes Authentication object model.

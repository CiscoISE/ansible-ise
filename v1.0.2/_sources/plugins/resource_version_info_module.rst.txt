...
.. _ansible_collections.cisco.ise.resource_version_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.resource_version_info`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Resource path parameter.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   `Resource Version reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Resource Version object model.

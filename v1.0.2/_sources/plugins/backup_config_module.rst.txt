...
.. _ansible_collections.cisco.ise.backup_config_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.backup_config`.
...
.. seealso::
   ...
   `Backup Config reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_

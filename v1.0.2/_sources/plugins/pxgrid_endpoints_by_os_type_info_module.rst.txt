...
.. _ansible_collections.cisco.ise.pxgrid_endpoints_by_os_type_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.pxgrid_endpoints_by_os_type_info`.
...
.. seealso::
   ...
   `Pxgrid Endpoints By Os Type Info reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Pxgrid Endpoints By Os Type Info object model.

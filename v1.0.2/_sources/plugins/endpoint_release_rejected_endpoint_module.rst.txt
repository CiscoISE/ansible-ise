...
.. _ansible_collections.cisco.ise.endpoint_release_rejected_endpoint_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.endpoint_release_rejected_endpoint`.
...
.. seealso::
   ...
   `Endpoint Release Rejected Endpoint reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Endpoint Release Rejected Endpoint object model.

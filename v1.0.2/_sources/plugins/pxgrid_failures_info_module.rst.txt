...
.. _ansible_collections.cisco.ise.pxgrid_failures_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.pxgrid_failures_info`.
...
.. seealso::
   ...
   `Pxgrid Failures reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Pxgrid Failures object model.

...
.. _ansible_collections.cisco.ise.sms_provider_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.sms_provider_info`.
...
.. seealso::
   ...
   `Sms Provider reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Sms Provider object model.

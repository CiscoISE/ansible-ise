...
.. _ansible_collections.cisco.ise.network_device_group_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.network_device_group_info`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Name path parameter. Colon is used as a separator instead of (#) in the NDG name. For example, if the name is a#b#c it should appear in the request URL as a b c.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">

...
.. _ansible_collections.cisco.ise.mnt_session_delete_all_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.mnt_session_delete_all`.
...
.. seealso::
   ...
   `Mnt Session Delete All reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Mnt Session Delete All object model.

...
.. _ansible_collections.cisco.ise.backup_last_status_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.backup_last_status_info`.
...
.. seealso::
   ...
   `Backup Last Status reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Backup Last Status object model.

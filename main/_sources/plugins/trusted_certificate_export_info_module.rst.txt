...
.. _ansible_collections.cisco.ise.trusted_certificate_export_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.trusted_certificate_export_info`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Id path parameter. The ID of the Trusted Certificate to be exported.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
...
.. seealso::
   ...
   `Trusted Certificate Export reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_

...
.. _ansible_collections.cisco.ise.anc_policy_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.anc_policy`.
                        ...
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=string</span>                                            </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>- QUARANTINE Allows you to use Exception policies (authorization policies) to limit or deny an endpoint access to the network. - PORTBOUNCE Resets the port on the network device to which the endpoint is connected. - SHUTDOWN Shuts down the port on the network device to which the endpoint is connected. - RE_AUTHENTICATE Re-authenticates the session from the endpoint.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
...
.. seealso::
   ...
   `Anc Policy reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_

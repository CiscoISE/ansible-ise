...
.. _ansible_collections.cisco.ise.device_administration_identity_stores_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.device_administration_identity_stores_info`.
...
.. seealso::
   ...
   `Device Administration Identity Stores reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Device Administration Identity Stores object model.

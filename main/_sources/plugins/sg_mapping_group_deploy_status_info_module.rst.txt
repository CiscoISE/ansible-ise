...
.. _ansible_collections.cisco.ise.sg_mapping_group_deploy_status_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.sg_mapping_group_deploy_status_info`.
...
.. seealso::
   ...
   `Sg Mapping Group Deploy Status reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Sg Mapping Group Deploy Status object model.

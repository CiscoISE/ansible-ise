...
.. _ansible_collections.cisco.ise.network_access_global_exception_rules_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.network_access_global_exception_rules_info`.

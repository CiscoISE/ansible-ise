...
.. _ansible_collections.cisco.ise.device_administration_service_names_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.device_administration_service_names_info`.
...
.. seealso::
   ...
   `Device Administration Service Names reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Device Administration Service Names object model.

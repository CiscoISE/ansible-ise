...
.. _ansible_collections.cisco.ise.pxgrid_security_group_acls_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.pxgrid_security_group_acls_info`.
...
.. seealso::
   ...
   `Pxgrid Security Group Acls Info reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Pxgrid Security Group Acls Info object model.

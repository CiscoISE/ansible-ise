...
.. _ansible_collections.cisco.ise.network_access_local_exception_rules_reset_hitcounts_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.network_access_local_exception_rules_reset_hitcounts`.
...
.. seealso::
   ...
   `Network Access Local Exception Rules Reset Hitcounts reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Network Access Local Exception Rules Reset Hitcounts object model.

...
.. _ansible_collections.cisco.ise.network_access_global_exception_rules_reset_hitcount_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.network_access_global_exception_rules_reset_hitcount`.
...
.. seealso::
   ...
   `Network Access Global Exception Rules Reset Hitcount reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Network Access Global Exception Rules Reset Hitcount object model.

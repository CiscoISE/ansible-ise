...
.. _ansible_collections.cisco.ise.egress_matrix_cell_clear_all_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.egress_matrix_cell_clear_all`.
...
.. seealso::
   ...
   `Egress Matrix Cell Clear All reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Egress Matrix Cell Clear All object model.

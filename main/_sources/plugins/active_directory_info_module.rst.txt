...
.. _ansible_collections.cisco.ise.active_directory_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.active_directory_info`.
...
.. seealso::
   ...
   `Active Directory reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_

...
.. _ansible_collections.cisco.ise.device_administration_authorization_rules_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.device_administration_authorization_rules_info`.

...
.. _ansible_collections.cisco.ise.portal_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.portal_info`.
...
.. seealso::
   ...
   `Portal reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Portal object model.

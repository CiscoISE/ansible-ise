...
.. _ansible_collections.cisco.ise.endpoint_deregister_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.endpoint_deregister`.
...
.. seealso::
   ...
   `Endpoint Deregister reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Endpoint Deregister object model.

...
.. _ansible_collections.cisco.ise.pxgrid_user_group_by_username_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.pxgrid_user_group_by_username_info`.
...
.. seealso::
   ...
   `Pxgrid User Group By Username Info reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Pxgrid User Group By Username Info object model.

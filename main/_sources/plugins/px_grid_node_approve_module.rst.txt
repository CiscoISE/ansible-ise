...
.. _ansible_collections.cisco.ise.px_grid_node_approve_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.px_grid_node_approve`.
...
.. seealso::
   ...
   `Px Grid Node Approve reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Px Grid Node Approve object model.

...
.. _ansible_collections.cisco.ise.egress_matrix_cell_bulk_monitor_status_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.egress_matrix_cell_bulk_monitor_status_info`.
...
.. seealso::
   ...
   `Egress Matrix Cell Bulk Monitor Status reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Egress Matrix Cell Bulk Monitor Status object model.

...
.. _ansible_collections.cisco.ise.active_directory_groups_by_domain_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.active_directory_groups_by_domain_info`.
                        ...
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=string</span>                                            </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Active Directory Get Groups By Domain Info&#x27;s additionalData.</div>
                                                        </td>
            </tr>
                                        <tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Active Directory Get Groups By Domain Info&#x27;s name.</div>
                                                        </td>
            </tr>
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Active Directory Get Groups By Domain Info&#x27;s value.</div>
                                                        </td>
            </tr>
...
.. seealso::
   ...
   `Active Directory Groups By Domain reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Active Directory Groups By Domain object model.

...
.. _ansible_collections.cisco.ise.mnt_session_by_username_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.mnt_session_by_username_info`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Username path parameter.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   `Mnt Session By Username reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Mnt Session By Username object model.

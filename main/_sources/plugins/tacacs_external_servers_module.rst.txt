...
.. _ansible_collections.cisco.ise.tacacs_external_servers_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.tacacs_external_servers`.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-connectionPort"></div>
                    <b>connectionPort</b>
                    <a class="ansibleOptionLink" href="#parameter-connectionPort" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The port to connect the server.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Tacacs External Servers&#x27;s description.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The server IPV4 address.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Tacacs External Servers&#x27;s id.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Tacacs External Servers&#x27;s name.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The server shared secret.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-singleConnect"></div>
                    <b>singleConnect</b>
                    <a class="ansibleOptionLink" href="#parameter-singleConnect" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Define the use of single connection.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
...
.. seealso::
   ...
   `Tacacs External Servers reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_

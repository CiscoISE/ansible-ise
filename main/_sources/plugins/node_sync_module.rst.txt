...
.. _ansible_collections.cisco.ise.node_sync_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.node_sync`.
...
.. seealso::
   ...
   `Node Sync reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Node Sync object model.

...
.. _ansible_collections.cisco.ise.guest_smtp_notification_settings_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.guest_smtp_notification_settings_info`.

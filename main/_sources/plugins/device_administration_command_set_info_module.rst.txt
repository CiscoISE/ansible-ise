...
.. _ansible_collections.cisco.ise.device_administration_command_set_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.device_administration_command_set_info`.
...
.. seealso::
   ...
   `Device Administration Command Set reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Device Administration Command Set object model.

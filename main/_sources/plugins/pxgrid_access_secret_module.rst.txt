...
.. _ansible_collections.cisco.ise.pxgrid_access_secret_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.pxgrid_access_secret`.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-peerNodeName"></div>
                    <b>peerNodeName</b>
                    <a class="ansibleOptionLink" href="#parameter-peerNodeName" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Pxgrid Access Secret&#x27;s peerNodeName.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   `Pxgrid Access Secret reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Pxgrid Access Secret object model.

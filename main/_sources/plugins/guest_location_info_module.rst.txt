...
.. _ansible_collections.cisco.ise.guest_location_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.guest_location_info`.
...
.. seealso::
   ...
   `Guest Location reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Guest Location object model.

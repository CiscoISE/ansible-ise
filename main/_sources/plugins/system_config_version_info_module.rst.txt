...
.. _ansible_collections.cisco.ise.system_config_version_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.system_config_version_info`.
...
.. seealso::
   ...
   `System Config Version reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the System Config Version object model.

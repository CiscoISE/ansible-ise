...
.. _ansible_collections.cisco.ise.endpoint_get_rejected_endpoints_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.endpoint_get_rejected_endpoints_info`.
...
.. seealso::
   ...
   `Endpoint Get Rejected Endpoints reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Endpoint Get Rejected Endpoints object model.

...
.. _ansible_collections.cisco.ise.telemetry_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.telemetry_info`.
...
.. seealso::
   ...
   `Telemetry Info reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_

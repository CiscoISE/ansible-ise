...
.. _ansible_collections.cisco.ise.pxgrid_service_unregister_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.pxgrid_service_unregister`.
...
.. seealso::
   ...
   `Pxgrid Service Unregister reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Pxgrid Service Unregister object model.

...
.. _ansible_collections.cisco.ise.pxgrid_user_groups_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.pxgrid_user_groups_info`.
...
.. seealso::
   ...
   `Pxgrid User Groups Info reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Pxgrid User Groups Info object model.

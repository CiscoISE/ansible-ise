...
.. _ansible_collections.cisco.ise.guest_user_approve_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.guest_user_approve`.
...
.. seealso::
   ...
   `Guest User Approve reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Guest User Approve object model.

...
.. _ansible_collections.cisco.ise.guest_user_sms_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.guest_user_sms`.
...
.. seealso::
   ...
   `Guest User Sms reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Guest User Sms object model.

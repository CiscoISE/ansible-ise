...
.. _ansible_collections.cisco.ise.device_administration_conditions_for_authentication_rule_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.device_administration_conditions_for_authentication_rule_info`.
...
.. seealso::
   ...
   `Device Administration Conditions For Authentication Rule reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Device Administration Conditions For Authentication Rule object model.

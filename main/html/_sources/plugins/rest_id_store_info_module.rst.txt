...
.. _ansible_collections.cisco.ise.rest_id_store_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.rest_id_store_info`.
...
.. seealso::
   ...
   `Rest Id Store reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_

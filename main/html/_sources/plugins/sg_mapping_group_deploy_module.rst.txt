...
.. _ansible_collections.cisco.ise.sg_mapping_group_deploy_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.sg_mapping_group_deploy`.
...
.. seealso::
   ...
   `Sg Mapping Group Deploy reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Sg Mapping Group Deploy object model.

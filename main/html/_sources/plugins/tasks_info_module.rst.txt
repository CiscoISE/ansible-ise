...
.. _ansible_collections.cisco.ise.tasks_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.tasks_info`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>TaskId path parameter. The id of the task executed before.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   `Tasks reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Tasks object model.

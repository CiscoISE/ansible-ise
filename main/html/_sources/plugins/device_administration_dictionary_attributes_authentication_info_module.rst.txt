...
.. _ansible_collections.cisco.ise.device_administration_dictionary_attributes_authentication_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.device_administration_dictionary_attributes_authentication_info`.
...
.. seealso::
   ...
   `Device Administration Dictionary Attributes Authentication reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Device Administration Dictionary Attributes Authentication object model.

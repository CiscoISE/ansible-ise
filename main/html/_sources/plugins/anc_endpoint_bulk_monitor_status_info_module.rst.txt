...
.. _ansible_collections.cisco.ise.anc_endpoint_bulk_monitor_status_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.anc_endpoint_bulk_monitor_status_info`.
...
.. seealso::
   ...
   `Anc Endpoint Bulk Monitor Status reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Anc Endpoint Bulk Monitor Status object model.

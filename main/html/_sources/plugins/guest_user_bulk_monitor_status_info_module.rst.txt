...
.. _ansible_collections.cisco.ise.guest_user_bulk_monitor_status_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.guest_user_bulk_monitor_status_info`.
...
.. seealso::
   ...
   `Guest User Bulk Monitor Status reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Guest User Bulk Monitor Status object model.

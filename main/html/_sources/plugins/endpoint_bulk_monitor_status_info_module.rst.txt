...
.. _ansible_collections.cisco.ise.endpoint_bulk_monitor_status_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.endpoint_bulk_monitor_status_info`.
...
.. seealso::
   ...
   `Endpoint Bulk Monitor Status reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Endpoint Bulk Monitor Status object model.

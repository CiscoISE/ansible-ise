...
.. _ansible_collections.cisco.ise.aci_bindings_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.aci_bindings_info`.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-filterBy"></div>
                    <b>filterBy</b>
                    <a class="ansibleOptionLink" href="#parameter-filterBy" title="Permalink to this option"></a>
                        ...
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=string</span>                                            </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>FilterBy query parameter.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-filterValue"></div>
                    <b>filterValue</b>
                    <a class="ansibleOptionLink" href="#parameter-filterValue" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=string</span>                                            </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>FilterValue query parameter.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
...
.. seealso::
   ...
   `Aci Bindings reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_

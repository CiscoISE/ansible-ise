...
.. _ansible_collections.cisco.ise.aci_test_connectivity_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.aci_test_connectivity`.
...
.. seealso::
   ...
   `Aci Test Connectivity reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Aci Test Connectivity object model.

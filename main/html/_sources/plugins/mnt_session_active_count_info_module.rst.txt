...
.. _ansible_collections.cisco.ise.mnt_session_active_count_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.ise.mnt_session_active_count_info`.
...
.. seealso::
   ...
   `Mnt Session Active Count reference <https://ciscoisesdk.readthedocs.io/en/latest/api/api.html#v3-0-0-summary>`_
       Complete reference of the Mnt Session Active Count object model.

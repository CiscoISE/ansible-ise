...
DOCUMENTATION = r"""
---
module: guesttype_info
short_description: Information module for Guesttype
description:
  - Get all Guesttype.
version_added: '1.0.0'
...
notes:
  - SDK Method used are
    guesttype.Guesttype.get_guesttype_generator,
  - Paths used are
    get /guesttype/,
"""
EXAMPLES = r"""
---
- name: Get all Guesttype
  cisco.ise.guesttype_info:

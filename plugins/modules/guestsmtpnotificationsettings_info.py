...
DOCUMENTATION = r"""
---
module: guestsmtpnotificationsettings_info
short_description: Information module for Guestsmtpnotificationsettings
description:
...
notes:
  - SDK Method used are
    guestsmtpnotificationsettings.Guestsmtpnotificationsettings.get_guestsmtpnotificationsettings_generator,

  - Paths used are
    get /guestsmtpnotificationsettings/,

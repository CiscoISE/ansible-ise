...
DOCUMENTATION = r"""
---
module: portalglobalsetting_info
short_description: Information module for Portalglobalsetting
description:
- Get all Portalglobalsetting.
version_added: '1.0.0'
...
notes:
  - SDK Method used are
    portalglobalsetting.Portalglobalsetting.get_portalglobalsetting_generator,

  - Paths used are
    get /portalglobalsetting/,

"""

EXAMPLES = r"""
- name: Get all Portalglobalsetting
  cisco.ise.portalglobalsetting_info:

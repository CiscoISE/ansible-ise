...
requirements:
  ...
  - python >= 3.5
notes:
  - SDK Method used are external_radius_server.ExternalRadiusServer.create_external_radius_server, external_radius_server.ExternalRadiusServer.delete_external_radius_server_by_id,

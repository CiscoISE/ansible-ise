...
DOCUMENTATION = r"""
---
module: downloadableacl_info
short_description: Information module for Downloadableacl
description:
...
options:
  filter:
    description:
    - Filter query parameter. Filter Supported Fields name, description, daclType.
...
notes:
  - SDK Method used are
    downloadableacl.Downloadableacl.get_downloadableacl_generator,
...
EXAMPLES = r"""
- name: Get all Downloadableacl
  cisco.ise.downloadableacl_info:

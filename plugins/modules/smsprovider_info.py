...
DOCUMENTATION = r"""
---
module: smsprovider_info
short_description: Information module for SMSprovider
description:
- Get all SMSprovider.
version_added: '1.0.0'
...
notes:
  - SDK Method used are
    smsprovider.Smsprovider.get_smsprovider_generator,
...
EXAMPLES = r"""
- name: Get all SMSprovider
  cisco.ise.smsprovider_info:

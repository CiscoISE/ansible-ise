...
DOCUMENTATION = r"""
---
module: mydeviceportal_info
short_description: Information module for Mydeviceportal
description:
...
notes:
  - SDK Method used are
    mydeviceportal.Mydeviceportal.get_mydeviceportal_generator,
...
EXAMPLES = r"""
- name: Get all Mydeviceportal
  cisco.ise.mydeviceportal_info:

...
notes:
  - SDK Method used are network_access_conditions.NetworkAccessConditions.create_network_access_condition, network_access_conditions.NetworkAccessConditions.delete_network_access_condition_by_id,
    network_access_conditions.NetworkAccessConditions.delete_network_access_condition_by_name, network_access_conditions.NetworkAccessConditions.update_network_access_condition_by_id,
    network_access_conditions.NetworkAccessConditions.update_network_access_condition_by_name,
  - Paths used are post /network-access/condition, delete /network-access/condition/condition-by-name/{name}, delete /network-access/condition/{id},
    put /network-access/condition/condition-by-name/{name}, put /network-access/condition/{id},
"""

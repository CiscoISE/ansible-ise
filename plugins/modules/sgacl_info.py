...
options:
  filter:
    description:
      - Filter query parameter. Filter Supported Fields ipVersion, sgAclType, name,
        description.
  ...
  sortdsc:
    description:
      - Sortdsc query parameter. Sorting Supported Fields ipVersion, sgAclType, name,
        description.
    type: str
  sortasc:
    description:
      - Sortasc query parameter. Sorting Supported Fields ipVersion, sgAclType, name,
        description.
    type: str
requirements:
  - ciscoisesdk >= 2.0.1

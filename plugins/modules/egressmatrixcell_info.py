...
options:
  filter:
    description:
      - >
        Filter query parameter. Filter Supported Fields sgtSrcValue, matrixStatus,
        description, matrixId, sgtSrcName, sgtDstName, sgtDstValue.
  ...
  sortdsc:
    description:
      - Sortdsc query parameter. Sorting Supported Fields description, sgtSrcName,
        sgtDstName, sgtDstValue.
    type: str
  sortasc:
    description:
      - Sortasc query parameter. Sorting Supported Fields description, sgtSrcName,
        sgtDstName, sgtDstValue.
    type: str
requirements:
  - ciscoisesdk >= 2.0.1

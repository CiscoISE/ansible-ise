...
DOCUMENTATION = r"""
---
module: hotspotportal_info
short_description: Information module for Hotspotportal
description:
- Get all Hotspotportal.
version_added: '1.0.0'
...
notes:
  - SDK Method used are
    hotspotportal.Hotspotportal.get_hotspotportal_generator,
...
EXAMPLES = r"""
- name: Get all Hotspotportal
  cisco.ise.hotspotportal_info:

...
short_description: Information module for Activedirectory
description:
  - Get all Activedirectory.
version_added: '1.0.0'
...
notes:
  - SDK Method used are
    activedirectory.Activedirectory.get_activedirectory_generator,
  - Paths used are
    get /activedirectory/,
"""
EXAMPLES = r"""
---
- name: Get all Activedirectory
  cisco.ise.activedirectory_info:

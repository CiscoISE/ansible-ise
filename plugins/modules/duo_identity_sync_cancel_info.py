...
description:
  ...
  - Cancel the sync between the Active Directory and the corresponding Mfa provider
...
options:
  syncName:
    description:
      - SyncName path parameter. Name of the Identitysync configuration used to cancel
        sync.
    type: str
requirements:
  - ciscoisesdk >= 2.0.1

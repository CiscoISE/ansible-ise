...
options:
  filter:
    description:
      - >
        Filter query parameter. Filter Supported Fields logicalProfileName, portalUser, staticProfileAssignment,
        profileId, profile, groupId, staticGroupAssignment, mac.
...
notes:
  - SDK Method used are
    endpoint.Endpoint.get_endpoint_generator,

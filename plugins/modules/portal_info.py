...
- module: cisco.ise.plugins.module_utils.definitions.portal
# Reference by Internet resource
- name: Portal reference
  description: Complete reference of the Portal object model.
...
ise_response:
  ...
  type: complex
  sample:
  - {'ERSPortal': {'id': 'string', 'name': 'string', 'description': 'string', 'allowSponsorToChangeOwnPassword': True, 'guestUserFieldList': [{'labelName': 'string', 'dataType': 'string', 'required': True, 'dictionaryLabelKey': 'string', 'customType': True}], 'portalType': 'string', 'link': {'rel': 'string', 'href': 'string', 'type': 'string'}}}

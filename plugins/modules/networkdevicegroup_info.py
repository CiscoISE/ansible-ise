...
DOCUMENTATION = r"""
---
module: networkdevicegroup_info
short_description: Information module for Networkdevicegroup
description:
- Get all Networkdevicegroup.
version_added: '1.0.0'
...
options:
  filter:
    description:
    - Filter query parameter. Filter Supported Fields name, description, type.
...
notes:
  - SDK Method used are
    networkdevicegroup.Networkdevicegroup.get_networkdevicegroup_generator,

  - Paths used are
    get /networkdevicegroup/,

"""

EXAMPLES = r"""
- name: Get all Networkdevicegroup

...
DOCUMENTATION = r"""
---
module: sxplocalbindings_info
short_description: Information module for SXPlocalbindings
description:
...
options:
  filter:
    description:
    - Filter query parameter. Filter Supported Fields sgt, vpn, vns, ipOrHost.
  ...
  sortdsc:
    description:
    - Sortdsc query parameter. Sorting Supported Fields sgt, vpn, ip, vns, ipOrHost.
    type: str
  sortasc:
    description:
    - Sortasc query parameter. Sorting Supported Fields sgt, vpn, ip, vns, ipOrHost.
    type: str
requirements:
- ciscoisesdk >= 2.0.1
- python >= 3.5
notes:
  - SDK Method used are
    sxplocalbindings.Sxplocalbindings.get_sxplocalbindings_generator,

  - Paths used are
    get /sxplocalbindings/,

"""

EXAMPLES = r"""
- name: Get all SXPlocalbindings
  cisco.ise.sxplocalbindings_info:

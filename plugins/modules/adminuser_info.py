...
DOCUMENTATION = r"""
---
module: adminuser_info
short_description: Information module for Adminuser
description:
- Get all Adminuser.
version_added: '1.0.0'
...
options:
  filter:
    description:
      - >
        Filter query parameter. Filter Supported Fields firstName, lastName, adminGroups, name, description,
        inactiveAccountNeverDisabled, includeSystemAlarmsInEmail, email, enabled.
...
notes:
  - SDK Method used are
    adminuser.Adminuser.get_adminuser_generator,
...
EXAMPLES = r"""
- name: Get all Adminuser
  cisco.ise.adminuser_info:

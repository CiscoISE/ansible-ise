...
DOCUMENTATION = r"""
---
module: sponsorgroup_info
short_description: Information module for Sponsorgroup
description:
- Get all Sponsorgroup.
version_added: '1.0.0'
...
notes:
  - SDK Method used are
    sponsorgroup.Sponsorgroup.get_sponsorgroup_generator,
...
EXAMPLES = r"""
- name: Get all Sponsorgroup
  cisco.ise.sponsorgroup_info:

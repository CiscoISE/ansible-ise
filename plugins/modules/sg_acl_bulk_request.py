...
- module: cisco.ise.plugins.module_utils.definitions.sg_acl_bulk_request
# Reference by Internet resource
- name: Sg Acl Bulk Request reference
  description: Complete reference of the Sg Acl Bulk Request object model.
...
- name: Update all
  cisco.ise.sg_acl_bulk_request:
    ...
    resourceMediaType: vnd.com.cisco.ise.trustsec.sgacl.1.0+xml

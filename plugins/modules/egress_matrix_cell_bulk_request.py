...
- module: cisco.ise.plugins.module_utils.definitions.egress_matrix_cell_bulk_request
...
- name: Update all
  cisco.ise.egress_matrix_cell_bulk_request:
    ...
    resourceMediaType: vnd.com.cisco.ise.trustsec.egressmatrixcell.1.0+xml

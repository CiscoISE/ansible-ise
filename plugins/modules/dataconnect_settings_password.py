...
options:
  password:
    description: 'Password for dataconnect user. Password must satisfy the following criteria - Contains at least one uppercase letter A-Z, Contains at least one
      lowercase letter a-z, Contains at least one digit 0-9, Contains at least one special character #$%&*+,-. ;=?^_~, Has at least 12 characters, Has not more than
      30 characters.'
    type: str
requirements:
  - ciscoisesdk >= 2.2.3

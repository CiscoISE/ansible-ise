...
requirements:
  ...
  - python >= 3.5
notes:
  - SDK Method used are user_equipment.UserEquipment.get_user_equipment_by_id, user_equipment.UserEquipment.get_user_equipments_generator,
  - Paths used are get /api/v1/fiveg/user-equipment, get /api/v1/fiveg/user-equipment/{userEquipmentId},
"""

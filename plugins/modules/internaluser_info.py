...
DOCUMENTATION = r"""
---
module: internaluser_info
short_description: Information module for Internaluser
description:
...
options:
  filter:
    description:
      - >
        Filter query parameter. Filter Supported Fields firstName, lastName, identityGroup, name, description,
        email, enabled.
  ...
  sortdsc:
    description:
      - >
        Sortdsc query parameter. Sorting Supported Fields daysTillPasswdExpiry, dateCreated, name, description,
        dateEnabled, dateModified.
    type: str
  sortasc:
    description:
      - >
        Sortasc query parameter. Sorting Supported Fields daysTillPasswdExpiry, dateCreated, name, description,
        dateEnabled, dateModified.
    type: str
requirements:
- ciscoisesdk >= 2.0.1
...
notes:
  - SDK Method used are
    internaluser.Internaluser.get_internaluser_generator,
...
EXAMPLES = r"""
- name: Get all Internaluser
  cisco.ise.internaluser_info:

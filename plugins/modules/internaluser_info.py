...
options:
  filter:
    description:
      - >
        Filter query parameter. Filter Supported Fields firstName, lastName, identityGroup,
  ...
  sortdsc:
    description:
      - >
        Sortdsc query parameter. Sorting Supported Fields daysTillPasswdExpiry, dateCreated,
        name, description, dateEnabled, dateModified.
    type: str
  sortasc:
    description:
      - >
        Sortasc query parameter. Sorting Supported Fields daysTillPasswdExpiry, dateCreated,
        name, description, dateEnabled, dateModified.
    type: str
requirements:
  - ciscoisesdk >= 2.0.1

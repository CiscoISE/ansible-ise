...
DOCUMENTATION = r"""
---
module: byodportal_info
short_description: Information module for BYODportal
description:
  - Get all BYODportal.
version_added: '1.0.0'
...
notes:
  - SDK Method used are
    byodportal.Byodportal.get_byodportal_generator,
  - Paths used are
    get /byodportal/,
"""
EXAMPLES = r"""
---
- name: Get all BYODportal
  cisco.ise.byodportal_info:

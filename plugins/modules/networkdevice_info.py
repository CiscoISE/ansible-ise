...
DOCUMENTATION = r"""
---
module: networkdevice_info
short_description: Information module for Networkdevice
description:
- Get all Networkdevice.
version_added: '1.0.0'
...
options:
  filter:
    description:
    - Filter query parameter. Filter Supported Fields ipaddress, name, description, location, type.
...
notes:
  - SDK Method used are
    networkdevice.Networkdevice.get_networkdevice_generator,

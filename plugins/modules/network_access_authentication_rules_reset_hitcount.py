...
- name: Network Access Authentication Rules Reset Hitcount reference
  description: Complete reference of the Network Access Authentication Rules Reset Hitcount object model.

...
notes:
  ...
  - Paths used are post /device-admin/condition, delete /device-admin/condition/condition-by-name/{name}, delete /device-admin/condition/{id}, put /device-admin/condition/condition-by-name/{name},

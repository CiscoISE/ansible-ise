...
DOCUMENTATION = r"""
---
module: ancpolicy_info
short_description: Information module for ANCpolicy
description:
- Get all ANCpolicy.
version_added: '1.0.0'
...
notes:
  - SDK Method used are
    ancpolicy.Ancpolicy.get_ancpolicy_generator,
...
EXAMPLES = r"""
- name: Get all ANCpolicy
  cisco.ise.ancpolicy_info:

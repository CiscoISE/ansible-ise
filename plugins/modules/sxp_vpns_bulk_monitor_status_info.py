...
- module: cisco.ise.plugins.module_utils.definitions.sxp_vpns_bulk_monitor_status
# Reference by Internet resource
- name: Sxp Vpns Bulk Monitor Status reference
  description: Complete reference of the Sxp Vpns Bulk Monitor Status object model.

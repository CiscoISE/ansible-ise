...
argument_spec.update(dict(
    ...
    deployTo=dict(type="dict"),
    deployType=dict(type="str"),
    sgt=dict(type="dict"),
    sgtDomain=dict(type="str"),
    name=dict(type="str"),
    id=dict(type="str"),
...
class Sgmappinggroup(object):
    def __init__(self, params, ise):
        ...
        self.new_object = dict(
            ...
            sgt=params.get("sgt"),
            sgt_domain=params.get("sgtDomain"),
    ...
    def get_object_by_name(self, name):
        ...
        gen_items_responses = self.ise.exec(
            family="sgmappinggroup",
            function="get_sgmappinggroup_generator"
        )
        try:
    ...
    def create(self):
        result = self.ise.exec(
            family="sgmappinggroup",
            function="create_sgmappinggroup",

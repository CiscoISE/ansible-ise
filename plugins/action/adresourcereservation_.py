...
class Adresourcereservation(object):
    def __init__(self, params, ise):
        self.ise = ise
        self.new_object = dict(
            node=params.get("node"),
            join_point_names=params.get("joinPointNames"),
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [
            ("node", "node"),
            ("joinPointNames", "join_point_names"),
            ("name", "name"),
            ("id", "id"),
    ...
    def update(self):
        ...
        result = self.ise.exec(
            family="adresourcereservation",
            function="update_adresourcereservation_by_id",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = Adresourcereservation(self._task.args, ise)

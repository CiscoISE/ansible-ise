...
argument_spec.update(dict(
    ...
    connectionSettings=dict(type="dict"),
    directoryOrganization=dict(type="dict"),
    groups=dict(type="dict"),
    attributes=dict(type="dict"),
    enablePasswordChangeLDAP=dict(type="bool"),
    name=dict(type="str"),
    id=dict(type="str"),
...
class Ldap(object):
    def __init__(self, params, ise):
        ...
        self.new_object = dict(
            ...
            directory_organization=params.get("directoryOrganization"),
            groups=params.get("groups"),
            attributes=params.get("attributes"),
            enable_password_change_lda_p=params.get("enablePasswordChangeLDAP"),
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [
            ...
            ("directoryOrganization", "directory_organization"),
            ("groups", "groups"),
            ("attributes", "attributes"),
            ("enablePasswordChangeLDAP", "enable_password_change_lda_p"),
            ("name", "name"),
            ("id", "id"),

...
class Activedirectory(object):
    ...
    def get_object_by_name(self, name):
        ...
        gen_items_responses = self.ise.exec(
            ...
            function="get_activedirectory_generator"
        )
        try:
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [
            ...
            ("enableDomainAllowedList", "enable_domain_allowed_list"),
            ("adgroups", "adgroups"),
            ("adAttributes", "ad_attributes"),
            ("advancedSettings", "advanced_settings"),
            ("ERSActiveDirectoryDomains", "ers_active_directory_domains"),
            ("name", "name"),
            ("id", "id"),
    ...
    def create(self):
        result = self.ise.exec(
            family="activedirectory",
            function="create_activedirectory",

...
argument_spec.update(dict(
    ...
    ersRestIDStoreDeviceAttributes=dict(type="dict"),
    ersRestIDStoreAdvanceSettings=dict(type="dict"),
    name=dict(type="str"),
    id=dict(type="str"),
...
class Restidstore(object):
    def __init__(self, params, ise):
        ...
        self.new_object = dict(
            ...
            ers_rest_idstore_device_attributes=params.get("ersRestIDStoreDeviceAttributes"),
            ers_rest_idstore_advance_settings=params.get("ersRestIDStoreAdvanceSettings"),
    ...
    def get_object_by_name(self, name):
        ...
        gen_items_responses = self.ise.exec(
            family="restidstore",
            function="get_restidstore_generator"
        )
        try:
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [
            ...
            ("ersRestIDStoreDeviceAttributes", "ers_rest_idstore_device_attributes"),
            ("ersRestIDStoreAdvanceSettings", "ers_rest_idstore_advance_settings"),
            ("name", "name"),
            ("id", "id"),

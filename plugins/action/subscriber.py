...
class Subscriber(object):
    ...
    def get_object_by_name(self, name):
        ...
        gen_items_responses = self.ise.exec(
            family="subscriber", function="get_all_subscribers_generator"
        )
        try:
    ...
    def update(self):
        ...
        result = self.ise.exec(
            family="subscriber", function="update_subscriber", params=self.new_object
        ).response
        return result
    ...
    def delete(self):
        ...
        if not id:
            ...
            self.new_object.update(dict(id=id_))
        result = self.ise.exec(
            family="subscriber", function="delete_subscriber", params=self.new_object
        ).response
        return result

...
argument_spec.update(dict(
    ...
    authenticationPort=dict(type="dict"),
    accountingPort=dict(type="dict"),
    timeout=dict(type="dict"),
    retries=dict(type="dict"),
    proxyTimeout=dict(type="dict"),
    msgAuthIsRequiredOnResponse=dict(type="bool"),
    name=dict(type="str"),
    id=dict(type="str"),
...
class Externalradiusserver(object):
    def __init__(self, params, ise):
        ...
        self.new_object = dict(
            ...
            msg_auth_is_required_on_response=params.get("msgAuthIsRequiredOnResponse"),
    ...
    def get_object_by_name(self, name):
        ...
        gen_items_responses = self.ise.exec(
            family="externalradiusserver",
            function="get_externalradiusserver_generator"
        )
        try:
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [
            ...
            ("msgAuthIsRequiredOnResponse", "msg_auth_is_required_on_response"),
            ("name", "name"),
            ("id", "id"),
    ...
    def create(self):
        result = self.ise.exec(
            family="externalradiusserver",
            function="create_externalradiusserver",

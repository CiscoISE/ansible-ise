...
argument_spec.update(dict(
    ...
    allowDynamicIdentityGroups=dict(type="bool"),
    dynamicGroups=dict(type="list"),
...
class Guesttype(object):
    def __init__(self, params, ise):
        ...
        self.new_object = dict(
            ...
            allow_dynamic_identity_groups=params.get("allowDynamicIdentityGroups"),
            dynamic_groups=params.get("dynamicGroups"),
    ...
    def get_object_by_name(self, name):
        ...
        gen_items_responses = self.ise.exec(
            family="guesttype",
            function="get_guesttype_generator"
        )
        try:
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [
            ...
            ("allowDynamicIdentityGroups", "allow_dynamic_identity_groups"),

...
argument_spec.update(dict(
    ...
    fiveG=dict(type="bool"),
    rsaPss=dict(type="bool"),
    displayAdditionalTLSParams=dict(type="bool"),
...
class Allowedprotocols(object):
    def __init__(self, params, ise):
        ...
        self.new_object = dict(
            ...
            five_g=params.get("fiveG"),
            rsa_pss=params.get("rsaPss"),
            display_additional_tls_params=params.get("displayAdditionalTLSParams"),
    ...
    def get_object_by_name(self, name):
        ...
        gen_items_responses = self.ise.exec(
            family="allowedprotocols",
            function="get_allowedprotocols_generator"
        )
        try:
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [
            ...
            ("fiveG", "five_g"),
            ("rsaPss", "rsa_pss"),
            ("displayAdditionalTLSParams", "display_additional_tls_params"),
    ...
    def create(self):
        result = self.ise.exec(
            family="allowedprotocols",
            function="create_allowedprotocols",

...
required_if = [
    ("state", "present", ["name", "settings"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class Selfregportal(object):
    ...
    def get_object_by_name(self, name):
        ...
        gen_items_responses = self.ise.exec(
            family="selfregportal",
            function="get_selfregportal_generator"
        )
        try:
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = Selfregportal(self._task.args, ise)
